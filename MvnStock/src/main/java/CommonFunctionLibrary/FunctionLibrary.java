...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser(WebDriver driver) throws Throwable
	{
	 if (PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox")) 
	 {
		System.setProperty("webdriver.gecko.driver", 
				"D:\\ESTHAN\\AUTOMATION\\Automation Testing\\MvnStock\\ExecutableFiles\\geckodriver.exe");
		driver=new FirefoxDriver();
	}else
		if (PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome")) 
		{
			System.setProperty("webdriver.chrome.driver","D:\\ESTHAN\\AUTOMATION\\Automation Testing\\MvnStock\\ExecutableFiles\\chromedriver.exe");
		...
		if (locatorType.equalsIgnoreCase("id")) 
	{
		...
		FileWriter fw=new FileWriter("D:\\ESTHAN\\AUTOMATION\\Automation Testing\\MvnStock\\CaptureData\\Data.txt");
	...
	public static void tableValidation(WebDriver driver,String column) throws Throwable
	{
		...
		FileReader fr=new FileReader("D:\\ESTHAN\\AUTOMATION\\Automation Testing\\MvnStock\\CaptureData\\Data.txt");
	...
	for(int i=1;i<=rows.size();i++)
	{
		...
		String act_data=driver.findElement(By.xpath("//*[@id='ewContentColumn']/div[3]/form/div//table[@id='tbl_a_supplierslist']"
				+ "/tbody/tr["+i+"]/td["+colNum+"]/div/span")).getText();
	...
	//mouse over and Click
		...
		public static void mouseClick(WebDriver driver,String locatorType,String locatorValue )
		{
			...
			mouseClick.moveToElement(driver.findElement(By.id("mi_a_stock_items"))).build().perform();
			mouseClick.moveToElement(driver.findElement(By.id("mi_a_stock_categories"))).click().build().perform();
		...
		public static void tableValidation1(WebDriver driver,String exp_data) throws Throwable, Throwable
		 {
			 if(driver.findElement(By.xpath(PropertyFileUtil.getValueForKey("Search.box1"))).isDisplayed())
				...
				WebElement webtable=driver.findElement(By.xpath(PropertyFileUtil.getValueForKey("webtable1.path1")));
				List<WebElement> rows=webtable.findElements(By.tagName("tr"));
